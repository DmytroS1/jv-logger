...
public class OrderServiceImpl implements OrderService {
    ...
    public Order completeOrder(Long userId) {
        logger.info("Method completeOrder was called. Params: userId={}, userId");// TODO: add log message about method completeOrder was called
    ...
    private List<Product> getAllProductsFromShoppingCart(Long userId) {
        ...
        logger.info("Data were fetched successfully from the DB. Params: products={}, products");// TODO: add log message about successful fetched data from DB
        return products;
    }
}
